...
const formatearMoneda = Intl.NumberFormat("es-CL", {
  style: "currency",
  currency: "CLP",
});
const totalGastado = document.querySelector("#total-gastado");
...
const cargarGastos = () => {
  ...
  gastos.forEach((gasto) => {
        ...
        <div class="gasto" data-id="${gasto.id}">
            <div class="gasto__info">
                <div>
                    ...
                    <p class="gasto__cantidad">${formatearMoneda.format(
                      gasto.precio
                    )}</p>
                </div>
    ...
    precioTotal += parseInt(gasto.precio);
  });
  totalGastado.innerHTML = formatearMoneda.format(precioTotal);
};
