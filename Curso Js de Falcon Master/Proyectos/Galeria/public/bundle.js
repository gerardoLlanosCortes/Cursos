...
contenedorCategorias$1.append(fragment);
...
const cargarImagen = (id, nombre, ruta, descripcion) => {
  ...
  galeria$4.querySelector(".galeria__titulo").textContent = nombre;
  galeria$4.querySelector(".galeria__descripcion-imagen-activa").textContent =
    descripcion;
...
const cargarAnteriorSiguiente = (direccion) => {
  ...
  const idImagenActual =
    parseInt(galeria$4.querySelector(".galeria__imagen").dataset.idImagen);
